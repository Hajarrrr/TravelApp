...
public class MyAdapterVoyagePrix extends RecyclerView.Adapter<MyAdapterVoyagePrix.MyViewHolder> {
    private MesPatientsVoyagePrix activity;
    private List<ModelVoyagePrix> mList;
    private FirebaseFirestore db = FirebaseFirestore.getInstance();

    public MyAdapterVoyagePrix(MesPatientsVoyagePrix activity , List<ModelVoyagePrix> mList){
