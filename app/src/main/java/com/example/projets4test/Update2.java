...
public class Update2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DocumentReference documentReference = fstore.collection("Voyageur").document(userid);
    ...
    private void updateProfile(String Nom,String Phone,String Cin, String Specialite) {
        ...
        fauth = FirebaseAuth.getInstance();
        userid = fauth.getCurrentUser().getUid();
        DocumentReference documentReference = FirebaseFirestore.getInstance().collection("Voyageur").document(userid);
        ...
        documentReference.update(map).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(Update2.this, "Profile updated", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Update2.this,Profile2.class));
                finish();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Update2.this, "Profile not updated", Toast.LENGTH_SHORT).show();
