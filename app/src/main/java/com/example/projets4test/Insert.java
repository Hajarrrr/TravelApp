...
public class Insert extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        z.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(com.example.projets4test.Insert.this, DataCrud.class));
                finish();
            }
        });
    ...
    private  void saveToFirestore(String id,String Nom,String Phone,String Cin, String Specialite, String email){
        ...
        if(!Nom.isEmpty() && !Phone.isEmpty() && !Cin.isEmpty() && !Specialite.isEmpty()){
            ...
            db.collection("Doctor").document(id).set(map)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(com.example.projets4test.Insert.this,"Data saved", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(com.example.projets4test.Insert.this,"Failed!!", Toast.LENGTH_SHORT).show();
