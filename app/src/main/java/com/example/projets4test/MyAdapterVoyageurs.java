...
public class MyAdapterVoyageurs extends RecyclerView.Adapter<MyAdapterVoyageurs.MyViewHolder> {
    private AdminGererVoyageurs activity;
    private List<ModelVoyageurs> mList;
    private FirebaseFirestore db = FirebaseFirestore.getInstance();

    public MyAdapterVoyageurs(AdminGererVoyageurs activity , List<ModelVoyageurs> mList){
    ...
    public void updateData(int position){
        ...
        Intent intent = new Intent(activity , AdminGererVoyageurs.class);
    ...
    public void deleteData(int position){
        ModelVoyageurs item = mList.get(position);
        db.collection("Voyageur").document(item.getId()).delete()
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(activity).inflate(R.layout.item_voyageurs, parent , false);
